    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('buyer', 'Buyer'), ('seller', 'Seller'), ('admin', 'Admin'), ('superadmin', 'Super Admin')], default='buyer', max_length=20)),
                ('email_verified', models.BooleanField(default=False)),
                ('phone_verified', models.BooleanField(default=False)),
                ('is_professional_seller', models.BooleanField(default=False)),
                ('seller_rating', models.FloatField(default=0.0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)])),
        ...
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['is_professional_seller'], name='accounts_us_is_prof_ab4b31_idx'),
        ),
    ]
